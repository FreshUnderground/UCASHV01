                    ...
                    children: [
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(statutIcon, size: 11, color: Colors.white),
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(fontSize: 8, color: Colors.grey[700], fontWeight: FontWeight.w500),
                            ),
                          ],
                        ),
                      ),
                  ...
                  if (isEnAttente && onServe != null) ...[
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: const Text('Servir', style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold)),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  label,
                  style: TextStyle(fontSize: 7, color: Colors.grey[600], fontWeight: FontWeight.w500),
                ),
                Text(
                  value,

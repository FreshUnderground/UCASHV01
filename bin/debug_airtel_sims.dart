  ...
  try {
    ...
    if (airtelSims.length >= 2) {
      ...
      if (sim1['id'] == sim2['id']) {
        ...
        print('   ⚠️ AVERTISSEMENT: Même numéro (${sim1['numero']}) mais IDs différents');
        ...
        print('      → SIM 1: Shop ${sim1['shop_id']} (${sim1['shop_designation']})');
        print('      → SIM 2: Shop ${sim2['shop_id']} (${sim2['shop_designation']})');
        print('      → Vérifier si le filtre de shop en local empêche de voir la 2e');
      } else {

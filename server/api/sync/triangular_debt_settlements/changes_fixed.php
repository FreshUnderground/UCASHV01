...
try {
    ...
    // CORRECTION 3: Inclure les règlements supprimés pour la synchronisation
    // (Important pour que les suppressions soient propagées)
    // Pas de filtre sur is_deleted - on récupère tout

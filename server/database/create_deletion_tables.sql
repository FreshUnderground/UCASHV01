...
CREATE INDEX IF NOT EXISTS idx_deletion_code_ops ON deletion_requests(code_ops);
...
CREATE INDEX IF NOT EXISTS idx_deletion_pending ON deletion_requests(statut, request_date);

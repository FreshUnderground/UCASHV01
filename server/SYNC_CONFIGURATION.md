...
```
GET https://safdal.investee-group.com/server/api/sync/ping.php
```

### 2. Upload des opérations (App → Serveur)
```
POST https://safdal.investee-group.com/server/api/sync/operations/upload.php
...
```
GET https://safdal.investee-group.com/server/api/sync/operations/changes.php?since=2024-11-08T00:00:00Z&user_id=agent_1

...
$ch = curl_init('https://safdal.investee-group.com/server/api/audit/log_capital_adjustment.php');
...
$ch = curl_init("https://safdal.investee-group.com/server/api/audit/get_capital_adjustments.php?shop_id=$shopId&limit=10");
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);

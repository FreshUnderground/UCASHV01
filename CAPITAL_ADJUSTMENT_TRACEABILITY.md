...
```bash
curl -X POST https://mahanaimeservice.investee-group.com/server/api/audit/log_capital_adjustment.php \
...
```bash
curl https://mahanaimeservice.investee-group.com/server/api/audit/get_capital_adjustments.php?shop_id=1&limit=10
```

...
https://safdal.investee-group.com/server/migrate_flot_shop_to_shop.php
```
...
<body>
    ...
    <script>
        async function testFlot() {
            ...
            try {
                const response = await fetch('https://safdal.investee-group.com/server/api/sync/operations/upload.php', {
                    method: 'POST',
                    headers: {
